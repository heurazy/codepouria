...
{
	// Token: 0x06000AE4 RID: 2788 RVA: 0x00035D2A File Offset: 0x00033F2A
	private void Start()
	{
		this.item = base.GetComponent<Item>();
	}

	// Token: 0x06000AE5 RID: 2789 RVA: 0x00035D38 File Offset: 0x00033F38
	private void Update()
	{
		...
		this.counter = 0f;
		base.GetComponent<PhotonView>().RPC("RPCA_TriggerBanana", RpcTarget.All, new object[] { Character.localCharacter.refs.view.ViewID });
	}

	// Token: 0x06000AE6 RID: 2790 RVA: 0x00035E00 File Offset: 0x00034000
	[PunRPC]
